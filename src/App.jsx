  ...
  return (
    ...
    <h1 className='font-bold text-center text-3xl'>Manage your todos at one place</h1>
      <div className="addTodo my-5 flex flex-col gap-4">
        ...
        <button onClick={handleAdd} disabled={todo.length<=3} className='bg-violet-800  hover:bg-violet-950 mx-2 rounded-full disabled:bg-violet-400 p-4 py-2 text-sm font-bold text-white'>Save</button>
        </div>
        </div>
